...
public class apiRequest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(zitatApiAbfrage());

    }

    // Hier wird die Quote-API abgerufen und eine HashMap mit Author, Zitat und Kategorie zurückgegeben.
    ...
    public static void fotoApiAbfrage() {
